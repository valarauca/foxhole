...
Rule::new(Some(35), Some("VEC_INT".to_string()), "vec<int>".to_string()).unwrap(),
Rule::new(Some(36), Some("VEC_BOOL".to_string()), "vec<bool>".to_string()).unwrap(),
...
Rule::new(Some(32), Some("TEMPLATE_FALLBACK".to_string()), ":-".to_string()).unwrap(),
Rule::new(Some(31), Some("TEMPLATE_ASSIGN".to_string()), ":=".to_string()).unwrap(),
Rule::new(Some(30), Some("TEMPLATE_START".to_string()), "\\$\\{".to_string()).unwrap(),
...
Rule::new(Some(29), Some("IDENT".to_string()), "[a-zA-Z_][a-zA-Z0-9_]*".to_string()).unwrap(),
Rule::new(Some(38), None, "((//|#![^\\n\\r]*)|[ \\t\\n\\r]+)".to_string()).unwrap(),
];
